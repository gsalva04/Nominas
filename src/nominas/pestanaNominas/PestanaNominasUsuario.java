...
//Clase para la visualizacion y la exportacion de las nominas personales del usuario
public class PestanaNominasUsuario extends javax.swing.JFrame {
    ...
    //Metodo para rellenar la tabla con los resultados coincidentes del insert
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(80, 20, 600, 190);
        ...
        jButton2.setBounds(580, 300, 100, 30);
        ...
        jButton3.setBounds(580, 260, 100, 30);
        ...
        jButton4.setBounds(580, 220, 100, 30);
        ...
        fechaInicio.setBounds(180, 240, 130, 30);
        jPanel1.add(fechaFin);
        fechaFin.setBounds(180, 280, 130, 30);

        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Fecha Fin");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(120, 280, 60, 30);
    ...
    //Accion del boton para ir al login
    ...
    //Accion del boton para exportar la nomina especificada (PDF, HTML, CSV)
    ...
    //Accion del boton para exportar la nomina especificada en XML
    ...
    //Accion del boton para exportar la nomina especificada en JSON
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PestanaNominasUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PestanaNominasUsuario().setVisible(true);
            }
        });
    }
